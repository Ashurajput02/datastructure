...
void insert(int a)
{
    ...
    temp->next = head;                                              /*isse kya hoga yadi a nonempty hoga toh a ka address will be stored in new node and iss new node ka address will be stored in head vioa next line*/
    head = temp;
    (head->next)->prev = head;
}
